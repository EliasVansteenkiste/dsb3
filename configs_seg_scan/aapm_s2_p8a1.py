...
data_iterator = data_iterators.AAPMScanLungMaskDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                             transform_params=p_transform,
                                                             data_prep_fun=data_prep_function,
                                                             exclude_pids=exclude_pids)

# create 4 data iterators with different indices to process
data_iterator0 = data_iterators.AAPMScanLungMaskDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                             transform_params=p_transform,
                                                             data_prep_fun=data_prep_function,
                                                             exclude_pids=exclude_pids,
                                                             part_out_of=(1, 4))

data_iterator1 = data_iterators.AAPMScanLungMaskDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                             transform_params=p_transform,
                                                             data_prep_fun=data_prep_function,
                                                             exclude_pids=exclude_pids,
                                                             part_out_of=(2, 4))

data_iterator2 = data_iterators.AAPMScanLungMaskDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                             transform_params=p_transform,
                                                             data_prep_fun=data_prep_function,
                                                             exclude_pids=exclude_pids,
                                                             part_out_of=(3, 4))

data_iterator3 = data_iterators.AAPMScanLungMaskDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                             transform_params=p_transform,
                                                             data_prep_fun=data_prep_function,
                                                             exclude_pids=exclude_pids,
                                                             part_out_of=(4, 4))
