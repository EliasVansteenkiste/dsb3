...
train_pids = train_pids[:21]
valid_pids = valid_pids[:16]
...
nchunks_per_epoch = 100  # train_data_iterator.nsamples / chunk_size
max_nchunks = 10000  # nchunks_per_epoch * 30
...
learning_rate_schedule = {
    0: 1e-4,
    int(2 * nchunks_per_epoch): 3e-5,
    int(4 * nchunks_per_epoch): 2e-5,
