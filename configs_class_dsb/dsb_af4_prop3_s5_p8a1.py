...
def load_pretrained_model(l_in):
    ...
    metadata = utils.load_pkl(os.path.join("/home/frederic/kaggle-dsb3/metadata/models/frederic/","r_elias_3-20170327-000644.pkl"))
    nn.layers.set_all_param_values(l, metadata['param_values'][:-20])
