...
# TODO: import correct config here
import configs_props_patch.luna_c3p1 as patch_size_config
...
def build_model():
    ...
    nodule_props_model = build_nodule_size_model(l_in_rshp)
    l_roi = nn.layers.ReshapeLayer(nodule_props_model.l_dense,
                                   (-1, n_candidates_per_patient, 128))

    nodule_props_model.l_dense.W.tag.grad_scale = 1.
    nodule_props_model.l_dense.b.tag.grad_scale = 1.
