...
def build_model():
    ...
    l_roi_p0 = nn.layers.DenseLayer(nodule_size_model.l_out.input_layer,
                                    num_units=1,
                                    W=nn.init.Constant(0.),
                                    b=nn.init.Constant(np.log(prior_p0 / (1 - prior_p0))),
                                    nonlinearity=nn.nonlinearities.sigmoid)

    l_roi_p0.input_layer.W.tag.grad_scale = untrained_weigths_grad_scale / 4.
    l_roi_p0.input_layer.b.tag.grad_scale = untrained_weigths_grad_scale / 4.
