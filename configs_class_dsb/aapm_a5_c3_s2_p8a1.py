...
train_valid_ids =id2candidates_path.keys() #utils.load_pkl(pathfinder.VALIDATION_SPLIT_PATH)
...
train_pids, valid_pids, test_pids = train_valid_ids[:50], train_valid_ids[50:], train_valid_ids[50:]
print 'n train', len(train_pids)
print 'n valid', len(valid_pids)

train_data_iterator = data_iterators.AAPMPatientsDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
...
valid_data_iterator = data_iterators.AAPMPatientsDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                              batch_size=1,
                                                              transform_params=p_transform,
                                                              n_candidates_per_patient=n_candidates_per_patient,
...
test_data_iterator = data_iterators.AAPMPatientsDataGenerator(data_path=pathfinder.AAPM_DATA_PATH,
                                                             batch_size=1,
                                                             transform_params=p_transform,
                                                             n_candidates_per_patient=n_candidates_per_patient,
                                                             data_prep_fun=data_prep_function_valid,
