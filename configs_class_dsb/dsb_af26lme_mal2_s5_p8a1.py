...
learning_rate_schedule = {
    0: 1e-5,
    int(2.5 * nchunks_per_epoch): 3e-6,
    int(4.5 * nchunks_per_epoch): 1e-6,
    int(6 * nchunks_per_epoch): 3e-7,
    int(7.5 * nchunks_per_epoch): 1e-7,
    int(8.5 * nchunks_per_epoch): 3e-8,
    int(9.25 * nchunks_per_epoch): 1e-8,
}
