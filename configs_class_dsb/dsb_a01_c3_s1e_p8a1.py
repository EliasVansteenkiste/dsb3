...
def build_model():
    ...
    l_roi = nn.layers.DenseLayer(l_d01, num_units=1, nonlinearity=nn.nonlinearities.sigmoid,
                                 W=nn.init.Constant(0.))
    l_roi_out = nn.layers.ReshapeLayer(l_roi, (-1, n_candidates_per_patient))

    l_out = nn.layers.FeaturePoolLayer(l_roi_out, pool_size=n_candidates_per_patient)
