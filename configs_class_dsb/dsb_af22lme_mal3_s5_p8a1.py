...
def load_pretrained_model(l_in):
    ...
    metadata = utils.load_pkl(os.path.join("/home/frederic/kaggle-dsb3/metadata/models/frederic/","r_fred_malignancy_3-20170329-230331-e5451.pkl"))
...
def build_model():
    ...
    l.input_layer.W.tag.grad_scale = grad_scale/2
    l.input_layer.b.tag.grad_scale = grad_scale/2

    l.W.tag.grad_scale = grad_scale
    l.b.tag.grad_scale = grad_scale
