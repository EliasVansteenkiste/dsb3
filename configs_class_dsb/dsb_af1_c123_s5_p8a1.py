...
def feat_red(lin):
    ...
    return l
def load_pretrained_model_c2(l_in):


    l = conv3d(l_in, num_filters=128)
    ...
    metadata = utils.load_pkl(os.path.join("/home/frederic/kaggle-dsb3/metadata/models/frederic/","luna_c2-20170225-214116.pkl"))
    nn.layers.set_all_param_values(l, metadata['param_values'][:-6])

    return l

def load_pretrained_model_c3(l_in):
...
def build_model():
    ...
    #l = nn.layers.DropoutLayer(penultimate_layer)
