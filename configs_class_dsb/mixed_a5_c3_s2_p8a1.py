...
train_data_iterator = data_iterators.MixedPatientsDataGenerator(data_path=pathfinder.DATA_PATH,aapm_data_path=pathfinder.AAPM_DATA_PATH,
...
valid_data_iterator = data_iterators.MixedPatientsDataGenerator(data_path=pathfinder.DATA_PATH,aapm_data_path=pathfinder.AAPM_DATA_PATH,
                                                              batch_size=1,
                                                              transform_params=p_transform,
                                                              n_candidates_per_patient=n_candidates_per_patient,
...
test_data_iterator = data_iterators.MixedPatientsDataGenerator(data_path=pathfinder.DATA_PATH,aapm_data_path=pathfinder.AAPM_DATA_PATH,
                                                             batch_size=1,
                                                             transform_params=p_transform,
                                                             n_candidates_per_patient=n_candidates_per_patient,
                                                             data_prep_fun=data_prep_function_valid,
