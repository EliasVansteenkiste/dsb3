...
# transformations
p_transform = {'patch_size': (432, 432, 432),
...
all_pids=all_pids[1040:]

for f_name in os.listdir("/home/frederic/kaggle-dsb3/metadata/model-predictions/frederic/dsb_c4_3"):
    parts = f_name.split(".")
    if parts[0] in all_pids:
        all_pids.remove(parts[0])
        print("Removed "+parts[0])
...
def build_model():
    ...
    metadata = utils.load_pkl(os.path.join("/home/frederic/kaggle-dsb3/metadata/models/frederic/","luna_c4-20170320-222617.pkl"))
