...
import configs_luna_patch.luna_p4 as patch_config
...
pad = stride / 2
pad_value = -1. * patch_config.zmuv_mean / patch_config.zmuv_std
...
print patch_config.zmuv_mean, patch_config.zmuv_std
