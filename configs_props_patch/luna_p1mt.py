...
p_transforms = [p_transform1, p_transform2]
...
p_transforms_augment = [p_transform_augment, None]
...
def build_model(l_ins=None):
    ...
    l_in3 = nn.layers.InputLayer((None, 1,) + p_transform2['patch_size']) if l_ins is None else l_ins[2]
