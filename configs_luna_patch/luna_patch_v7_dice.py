...
learning_rate_schedule = {
    0: 1e-6,
    int(max_nchunks * 0.1): 7e-7,
    int(max_nchunks * 0.2): 6e-7,
    int(max_nchunks * 0.3): 5e-7,
    int(max_nchunks * 0.4): 4e-7,
    int(max_nchunks * 0.5): 3e-7,
    int(max_nchunks * 0.6): 2e-7,
    int(max_nchunks * 0.7): 1e-7,
    int(max_nchunks * 0.8): 1e-8,
}
...
def build_model():
    ...
    net['expand_1_4'] = conv3d(net['expand_1_3'], base_n_filters)
    net['expand_1_4'] = nn.layers.ParametricRectifierLayer(net['expand_1_4'])
