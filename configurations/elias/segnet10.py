...
learning_rate_schedule = {
    0: 5e-5,
    int(num_epochs * 0.2): 2e-5,
    int(num_epochs * 0.2): 1e-5,
    int(num_epochs * 0.3): 5e-6,
    int(num_epochs * 0.4): 3e-6,
    int(num_epochs * 0.5): 2e-6,
    int(num_epochs * 0.6): 1e-6,
    int(num_epochs * 0.85): 5e-7,
    int(num_epochs * 0.95): 1e-7
}
