...
from application.preprocessors.augment_candidates import AugmentCandidates
...
preprocessors = {
    "train":
    [   AugmentCandidates(train_valid='train', tags=["luna:3d", "luna:target"],
    ...
    "valid":
    [   AugmentCandidates(train_valid='valid', tags=["luna:3d", "luna:target"],
               output_shape=(IMAGE_SIZE,IMAGE_SIZE,IMAGE_SIZE),  # in pixels
               norm_patch_shape=(IMAGE_SIZE,IMAGE_SIZE,IMAGE_SIZE),  # in mms
               augmentation_params=AUGMENTATION_PARAMETERS
               ),
...
def build_objectives(interface_layers):
    ...
    objectives = {  "train": {"objective": obj,},
                    "validate": {"objective": obj,},    
    }
    return objectives
