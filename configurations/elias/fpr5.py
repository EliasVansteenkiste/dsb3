...
from application.objectives import BinaryCrossEntropyObjective
...
def build_objectives(interface_layers):
    ...
    obj = BinaryCrossEntropyObjective(interface_layers["outputs"], target_name="luna")
    return {
        "train":{
            "objective": obj,
        },
...
def build_model(image_size=(IMAGE_SIZE,IMAGE_SIZE,IMAGE_SIZE)):
    ...
    l = lasagne.layers.GlobalPoolLayer(drop(l))
