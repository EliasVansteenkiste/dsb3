...
from application.preprocessors.augment_roi_zero_pad_top import AugmentROIZeroPadTop
...
roi_config = "configurations.elias.roi_stage1_1_wls_wfpr_x8"
max_rois = 16
...
augment_roi = partial(AugmentROIZeroPadTop,
    max_rois=max_rois,
