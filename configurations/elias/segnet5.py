# same as segnet1 but different learning rate
...
learning_rate_schedule = {
    0: 1e-4,
    int(num_epochs * 0.4): 5e-5,
    int(num_epochs * 0.5): 1e-5,
    int(num_epochs * 0.6): 5e-6,
    int(num_epochs * 0.85): 3e-6,
    int(num_epochs * 0.95): 1e-6
}
