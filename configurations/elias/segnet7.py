#A copy from segnet3 with a bugfix
...
def build_model(image_size=(IMAGE_SIZE,IMAGE_SIZE,IMAGE_SIZE)):
    ...
    net['contr_1_4'] = lasagne.layers.ParametricRectifierLayer(net['contr_1_4'])

    net['pool1'] = max_pool3d(net['contr_1_4'])

    net['contr_2_1'] = conv3d(net['pool1'], base_n_filters)
    net['contr_2_1'] = lasagne.layers.ParametricRectifierLayer(net['contr_2_1'])
    net['contr_2_2'] = conv3d(net['contr_2_1'], base_n_filters)
    net['contr_2_2'] = lasagne.layers.ParametricRectifierLayer(net['contr_2_2'])

    net['pool2'] = max_pool3d(net['contr_2_2'])

    net['contr_3_1'] = conv3d(net['pool2'], base_n_filters)
    net['contr_3_1'] = lasagne.layers.ParametricRectifierLayer(net['contr_3_1'])
    
    net['dropout_1'] = lasagne.layers.DropoutLayer(net['contr_3_1'])
    

    net['upscale1'] = lasagne.layers.Upscale3DLayer(net['dropout_1'], 2)
    net['concat1'] = lasagne.layers.ConcatLayer([net['upscale1'], net['contr_2_2']],
    ...
    net['concat2'] = lasagne.layers.ConcatLayer([net['upscale1'], net['contr_1_4']],
                                           cropping=(None, None, "center", "center", "center"))
    net['expand_2_1'] = conv3d(net['concat2'], base_n_filters)
    net['expand_2_1'] = lasagne.layers.ParametricRectifierLayer(net['expand_2_1'])
    net['expand_2_2'] = conv3d(net['expand_2_1'], base_n_filters)
    net['expand_2_2'] = lasagne.layers.ParametricRectifierLayer(net['expand_2_2'])


    net['output_segmentation'] = dnn.Conv3DDNNLayer(net['expand_2_2'], num_filters=1,
                               filter_size=1,
