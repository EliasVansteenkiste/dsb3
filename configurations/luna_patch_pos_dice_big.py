...
train_data_iterator = data_iterators.PatchPositiveLunaDataGenerator(data_path=pathfinder.LUNA_DATA_PATH,
                                                                    ...
                                                                    rng=rng,
                                                                    patient_ids=train_valid_ids['train'][1:2],
...
def build_model():
    ...
    net['pool4'] = max_pool3d(net['contr_4_2'])

    net['encode_1'] = conv3d(net['pool4'], base_n_filters * 16)
    ...
    l_out = dnn.Conv3DDNNLayer(net['expand_4_2'], num_filters=1,
                               filter_size=1,
