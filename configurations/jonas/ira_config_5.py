...
from application.preprocessors.lio_augmentation import AugmentOnlyPositive
...
conv3d_zeros = partial(dnn.Conv3DDNNLayer,
                 filter_size=3,
                 pad='valid',
...
def build_model():
    ...
    net = {}
    base_n_filters = 128
    net['1_1'] = lasagne.layers.ParametricRectifierLayer(conv3d(l0, base_n_filters))
    net['1_2'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['1_1'], base_n_filters))
    net['1_3'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['1_2'], base_n_filters))
    net['pool1'] = max_pool3d(net['1_3'])

    net['2_1'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['pool1'], 2*base_n_filters))
    net['2_2'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['2_1'], 2*base_n_filters))
    net['pool2'] = max_pool3d(net['2_2'])

    net['3_1'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['pool2'], 4*base_n_filters))
    net['3_2'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['3_1'], 4*base_n_filters))
    net['3_3'] = lasagne.layers.ParametricRectifierLayer(conv3d_zeros(net['3_2'], 4*base_n_filters))

    net['upscale2'] = Upscale3DLayer(net['3_3'], 2)
    net['concat2'] = lasagne.layers.ConcatLayer([net['2_2'], net['upscale2']],
                                           cropping=(None, None, "center", "center", "center"))

    net['2_3'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['concat2'], 2*base_n_filters))
    net['2_4'] = lasagne.layers.ParametricRectifierLayer(conv3d_zeros(net['2_3'], 2*base_n_filters))
    net['upscale1'] = Upscale3DLayer(net['2_4'], 2)

    net['concat1'] = lasagne.layers.ConcatLayer([net['upscale1'], net['1_3']],
                                           cropping=(None, None, "center", "center", "center"))

    net['1_4'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['concat1'], base_n_filters))

    l_out = dnn.Conv3DDNNLayer(net['1_4'], num_filters=1,
                               filter_size=1,
