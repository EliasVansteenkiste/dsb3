...
def build_model():
    ...
    net['2_1'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['pool1'], base_n_filters))
    net['2_2'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['2_1'], base_n_filters))
    net['pool2'] = max_pool3d(net['2_2'])

    net['3_1'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['pool2'], base_n_filters))
    net['3_2'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['3_1'], base_n_filters))
    net['3_3'] = lasagne.layers.ParametricRectifierLayer(conv3d_zeros(net['3_2'], base_n_filters))
    ...
    net['2_3'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['concat2'], base_n_filters))
    net['2_4'] = lasagne.layers.ParametricRectifierLayer(conv3d_zeros(net['2_3'], base_n_filters))
