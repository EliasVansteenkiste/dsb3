...
def build_model():
    ...
    net['3_3'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['3_2'], 4*base_n_filters))

    net['upscale2'] = Upscale3DLayer(net['3_3'], 2)
    net['concat2'] = lasagne.layers.ConcatLayer([net['2_2'], net['upscale2'], net['pool1']],
    ...
    net['2_4'] = lasagne.layers.ParametricRectifierLayer(conv3d(net['2_3'], 2*base_n_filters))
    net['upscale1'] = Upscale3DLayer(net['2_4'], 2)

    net['concat1'] = lasagne.layers.ConcatLayer([l0, net['upscale1'], net['1_3']],
                                           cropping=(None, None, "center", "center", "center"))
