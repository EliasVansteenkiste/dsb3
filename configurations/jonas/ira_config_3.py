...
def build_model():
    ...
    net['pool2'] = max_pool3d(net['encode_2'])

    net['encode_1b'] = conv3d(net['pool2'], base_n_filters)
    net['encode_1b'] = lasagne.layers.ParametricRectifierLayer(net['encode_1b'])
    net['encode_2b'] = conv3d(net['encode_1b'], base_n_filters)
    net['encode_2b'] = lasagne.layers.ParametricRectifierLayer(net['encode_2b'])
    net['encode_3b'] = conv3d(net['encode_2b'], base_n_filters)
    net['encode_3b'] = lasagne.layers.ParametricRectifierLayer(net['encode_3b'])
    net['upscale2'] = Upscale3DLayer(net['encode_3b'], 2)

    net['concat1'] = lasagne.layers.ConcatLayer([net['pool1'], net['upscale2'], net['encode_2']],
                                           cropping=(None, None, "center", "center", "center"))

    net['encode_3'] = conv3d(net['concat1'], base_n_filters)
    net['encode_3'] = lasagne.layers.ParametricRectifierLayer(net['encode_3'])
    net['upscale1'] = Upscale3DLayer(net['encode_3'], 2)
