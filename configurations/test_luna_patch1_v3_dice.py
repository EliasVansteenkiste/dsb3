...
data_prep_function_test = partial(data_prep_function, p_transform_augment=p_transform_augment, p_transform=p_transform)
...
max_nchunks = nchunks_per_epoch * 10000

validate_every = int(100000. * nchunks_per_epoch)
save_every = int(100000 * nchunks_per_epoch)

learning_rate_schedule = {
    0: 1e-5,
    # int(max_nchunks * 0.2): 0.0003,
