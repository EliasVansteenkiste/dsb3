...
def build_model():
    ...
    net['contr_2_1'] = conv3d(net['contr_1_2'], base_n_filters * 2)
    net['contr_2_2'] = conv3d(net['contr_2_1'], base_n_filters * 2)

    net['contr_3_1'] = conv3d(net['contr_2_2'], base_n_filters * 4)
    net['contr_3_2'] = conv3d(net['contr_3_1'], base_n_filters * 4)

    l_out = dnn.Conv3DDNNLayer(net['contr_3_2'], num_filters=1,
                               filter_size=1,
