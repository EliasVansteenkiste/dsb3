...
from application.preprocessors.augment_roi_prob import AugmentROIProb
...
augment_roi = partial(AugmentROIProb,
    max_rois=max_rois,
...
def build_model():
    ...
    l = lasagne.layers.ReshapeLayer(l, (-1, max_rois, 64))
