...
def build_model():
    ...
    l_volume_mu_sigma0 = nn_lung.JeroenLayer([nn.layers.flatten(l_mu0), nn.layers.flatten(l_sigma0),
    ...
    l_cdf0 = nn_lung.NormalCDFLayer(nn.layers.reshape(l_volume_mu0, ([0], 1)),
    ...
    l_volume_mu_sigma1 = nn_lung.JeroenLayer([nn.layers.flatten(l_mu1), nn.layers.flatten(l_sigma1),
                                              l_in_slice_mask, nn.layers.flatten(l_in_slice_location)],
                                             trainable_scale=False)
    ...
    l_cdf1 = nn_lung.NormalCDFLayer(nn.layers.reshape(l_volume_mu1, ([0], 1)),
