...
def inrn_v2(lin):
    ...
    l1 = bn(conv3d(lin, n_base_filter, filter_size=1))

    l2 = bn(conv3d(lin, n_base_filter, filter_size=1))
    l2 = bn(conv3d(l2, n_base_filter, filter_size=3))

    l3 = bn(conv3d(lin, n_base_filter, filter_size=1))
    l3 = bn(conv3d(l3, n_base_filter, filter_size=3))
    l3 = bn(conv3d(l3, n_base_filter, filter_size=3))

    l = lasagne.layers.ConcatLayer([l1, l2, l3])

    l = bn(conv3d(l, lin.output_shape[1], filter_size=1))
