...
def inception_v4(lin):
    ...
    l2 = conv3d(l2, n_base_filter, filter_size=(3,1,1))
    l2 = conv3d(l2, n_base_filter, filter_size=(1,3,1))
    l2 = conv3d(l2, n_base_filter, filter_size=(1,1,3))

    l3 = conv3d(lin, n_base_filter, filter_size=1)
    l3 = conv3d(l3, n_base_filter, filter_size=(3,1,1))
    l3 = conv3d(l3, n_base_filter, filter_size=(1,3,1))
    l3 = conv3d(l3, n_base_filter, filter_size=(1,1,3))
    l3 = conv3d(l3, n_base_filter, filter_size=(3,1,1))
    l3 = conv3d(l3, n_base_filter, filter_size=(1,3,1))
    l3 = conv3d(l3, n_base_filter, filter_size=(1,1,3))
