...
restart_from_file = '/home/eavsteen/dsb3/storage/metadata/dsb3//models/eavsteen/luna_direct_v7-20170209-104801.pkl'
...
def build_model():
    ...
    l = nl(bn(conv3d(l, num_filters=128)))
    l = nl(bn(conv3d(l, num_filters=128)))
    l = max_pool3d(l)
    l = drop(l)

    l = nl(bn(conv3d(l, num_filters=256)))
    l = nl(bn(conv3d(l, num_filters=256)))
    l = max_pool3d(l)
    l = drop(l)
