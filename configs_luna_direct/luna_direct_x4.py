...
def inception_v4(lin):
    ...
    l1 = conv3d(lin, 16, filter_size=1)

    l2 = conv3d(lin, 16, filter_size=1)
    l2 = conv3d(l2, 16, filter_size=3)

    l3 = conv3d(lin, 16, filter_size=1)
    l3 = conv3d(l3, 16, filter_size=3)
    l3 = conv3d(l3, 16, filter_size=3)
