...
pid2mu = utils_lung.get_patient_normparam_prediction(mu_predictions, batch_ids)
pid2sigma = utils_lung.get_patient_normparam_prediction(sigma_predictions, batch_ids)
valid_pid2musigma = {}
...
for id in valid_avg_patient_predictions.iterkeys():
    crpss_sys.append(utils_lung.crps(valid_avg_patient_predictions[id][0], patient_targets[id][0]))
    crpss_dst.append(utils_lung.crps(valid_avg_patient_predictions[id][1], patient_targets[id][1]))
...
for id in train_avg_patient_predictions.iterkeys():
    crpss_sys.append(utils_lung.crps(train_avg_patient_predictions[id][0], patient_targets[id][0]))
    crpss_dst.append(utils_lung.crps(train_avg_patient_predictions[id][1], patient_targets[id][1]))
    print id, 0.5 * (crpss_sys[-1] + crpss_dst[-1]), crpss_sys[-1], crpss_dst[-1]
